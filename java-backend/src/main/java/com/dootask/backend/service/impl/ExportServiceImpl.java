...
public class ExportServiceImpl implements ExportService {
    ...
    public void exportTasks(Long projectId, String format, HttpServletResponse response) {
        try {
            ...
            if (projectId != null) {
                ...
                tasks = taskService.getAllTasks(null, null);
            }
    ...
    // 其他导出方法的实现...
    private void exportTasksToExcel(List<Task> tasks, String filename, HttpServletResponse response) throws IOException {
        // 实现任务导出到Excel的逻辑
    }

    private void exportTasksToCsv(List<Task> tasks, String filename, HttpServletResponse response) throws IOException {
        // 实现任务导出到CSV的逻辑
    }
