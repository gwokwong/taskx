...
public class StatisticsServiceImpl implements StatisticsService {
    ...
    public StatisticsDto getOverviewStatistics(Long userId) {
        ...
        stats.setTotalFiles(fileEntityMapper.selectCount(new QueryWrapper<FileEntity>().eq("userid", userId)));
    ...
    public StatisticsDto getSystemStatistics() {
        ...
        stats.setTotalFiles(fileEntityMapper.selectCount(null));
    ...
    public Map<String, Long> getFileTypeStatistics(Long userId) {
        List<FileEntity> files = fileEntityMapper.selectList(new QueryWrapper<FileEntity>().eq("userid", userId));
