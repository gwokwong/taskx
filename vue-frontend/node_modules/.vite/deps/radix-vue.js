...
var $f2f3e0e3a817edbd$export$5baab4758c231076 = class extends $f2f3e0e3a817edbd$export$2066795aadd37bfc {
  fromJulianDay(jd2) {
    ...
    if (days < startDays || days > endDays)
      return super.fromJulianDay(jd2);
    else {
...
var $7c5f6fbf42389787$export$ca405048b8fb5af = class {
  ...
  toJulianDay(date) {
    ...
    for (let month = 1; month < date.month; month++)
      jd2 += $7c5f6fbf42389787$var$getDaysInMonth(date.year, month);
  ...
  setup(a2, { emit: t }) {
    ...
    watch(F, (de) => {
      if (Array.isArray(de) && de.length) {
        ...
        !Array.isArray(de) && de && !$14e0f24ef4ac5c92$export$91b62ebf2ba703ee(H2.value, de) && Q(de);
    });
    function be(de) {
      if (v2.value) {
        if (!F.value)
        ...
        switch (P2.key) {
          ...
          case "Backspace": {
            ...
            if (h2.value) {
              ...
              P2.key === "Backspace" && (h2.value = M, P2.preventDefault());
            break;
          }
          case "Home":
          case "End":
